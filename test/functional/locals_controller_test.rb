...
class LocalsControllerTest < ActionController::TestCase
  ...
  test "should create local" do
    assert_difference('Local.count') do
      post :create, local: { address: @local.address, address_google_maps: @local.address_google_maps, distrit: @local.distrit, first_phone: @local.first_phone, name: @local.name }
    end
  ...
  test "should update local" do
    put :update, id: @local, local: { address: @local.address, address_google_maps: @local.address_google_maps, distrit: @local.distrit, first_phone: @local.first_phone, name: @local.name }
    assert_redirected_to local_path(assigns(:local))
  end
