...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { band_id: @concert.band_id, end_date: @concert.end_date, local_id: @concert.local_id, start_date: @concert.start_date, user_id: @concert.user_id }
    end
  ...
  test "should update concert" do
    put :update, id: @concert, concert: { band_id: @concert.band_id, end_date: @concert.end_date, local_id: @concert.local_id, start_date: @concert.start_date, user_id: @concert.user_id }
    assert_redirected_to concert_path(assigns(:concert))
  end
